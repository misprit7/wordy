<p align="center">
  <img src="assets/logo.png" alt="Wordy" width="200" />
</p>

<h1 align="center">Wordy</h1>

<p align="center">
  A compiler for the powerful .docx programming language
  <br />
  <a href="https://xander.naumenko.com/wordy/"><strong>Try it online</strong></a>
</p>
...
```
src/                  Core library (Reader, Parser, Emitter, Compiler)
cli/                  CLI entry point and debug tools
web/                  Blazor WASM online compiler
